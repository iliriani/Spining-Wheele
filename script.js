var padding = { top: 20, right: 40, bottom: 0, left: 0 },
       w = Math.min(window.innerWidth, window.innerHeight) - padding.left - padding.right, // Adjusted width
    h = Math.min(window.innerWidth, window.innerHeight) - padding.top - padding.bottom, // Adjusted height
        r = Math.min(w, h) / 2,
        rotation = 0,
        oldrotation = 0,
        picked = 100000,
